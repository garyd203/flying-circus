...
class AutoScalingGroupProperties(ResourceProperties):
    ...
    CapacityRebalance = attrib(default=None)
    ...
    MaxInstanceLifetime = attrib(default=None)
    ...
    NewInstancesProtectedFromScaleIn = attrib(default=None)
...
class LaunchConfigurationProperties(ResourceProperties):
    ...
    LaunchConfigurationName = attrib(default=None)
    MetadataOptions = attrib(default=None)
